	...
	return {
		...
		"options": {
			...
			fountain :
			{
				...
				particleTexture : THREE.ImageUtils.loadTexture( 'js/textures/raindrop.png' ),
			...
			fireball :
			{
				...
				particleTexture : THREE.ImageUtils.loadTexture( 'js/textures/smokeparticle.png' ),
			...
			snow :
			{
				...
				particleTexture : THREE.ImageUtils.loadTexture( 'js/textures/snowflake.png' ),
			...
			starfield :
			{
				...
				particleTexture : THREE.ImageUtils.loadTexture( 'js/textures/spikey.png' ),
			...
			fireflies :
			{
				...
				particleTexture : THREE.ImageUtils.loadTexture( 'js/textures/spark.png' ),
